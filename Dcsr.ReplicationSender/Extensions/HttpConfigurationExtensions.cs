...
namespace System.Web.Http
{
    ...
    public static class HttpConfigurationExtensions
    {
        ...
        /// Set the '<c>MS_WebHookReceiverSecret_Graph</c>' application setting to the application secrets, optionally using IDs
        ...
        public static void InitializeReceiveGraphWebHooks(this HttpConfiguration config)
        {
